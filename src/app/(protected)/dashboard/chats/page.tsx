 ...
 *
 * Displays the list of all synced chats with the ability to view,
...
export default function ChatsPage() {
  ...
  // Fetch chats via API (silent mode for realtime updates)
  ...
  // Real-time subscription for syncing chats across devices
  // Uses direct state updates instead of refetching to reduce server load
  useEffect(() => {
    if (!account?.id) return;
    ...
    const channel = supabase
      ...
      .on(
        ...
        (payload: { new: Record<string, unknown> }) => {
          ...
          setChats((prev) => {
            ...
            // Add new chat at the top with message count 0
      ...
      .on(
        ...
        (payload: { new: Record<string, unknown> }) => {
          ...
          // Update in place if exists, move to top
          setChats((prev) => {
            ...
            // Update and move to top (most recently updated)
