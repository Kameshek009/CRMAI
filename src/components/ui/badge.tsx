  ...
  "inline-flex items-center justify-center rounded-full border px-2 py-0.5 text-xs font-medium w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 gap-1 [&>svg]:pointer-events-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive transition-all duration-200 ease-out overflow-hidden",
  {
    variants: {
      variant: {
        ...
        destructive:
          "border-transparent bg-destructive text-destructive-foreground [a&]:hover:bg-destructive/90 [a&]:hover:shadow-sm [a&]:hover:shadow-destructive/20 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40 dark:bg-destructive/60",
        outline:
          "text-foreground [a&]:hover:bg-accent [a&]:hover:text-accent-foreground [a&]:hover:shadow-sm",
        gradient:
          "border-transparent text-white bg-gradient-to-r from-[var(--accent-blue)] to-[#a78bfa] [a&]:hover:shadow-md [a&]:hover:shadow-[rgba(126,196,227,0.25)]",
        success:
        ...
        warning:
          "border-transparent bg-[var(--warning)]/15 text-[var(--warning)] dark:bg-[var(--warning)]/20 [a&]:hover:shadow-sm [a&]:hover:shadow-[var(--warning)]/15",
      },
    },
    defaultVariants: {
      variant: "default",
